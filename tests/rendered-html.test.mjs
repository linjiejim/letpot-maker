...
test("renders the separate parametric Studio", async () => {
  ...
  assert.match(html, /Keep proportions/);
  assert.match(html, /Topper height<\/span><output>65\.0<!-- --> mm/);
  ...
  assert.match(html, /Soft Sculpt/);
  assert.match(html, /Filter designs by style/);
  assert.match(html, /Print setup/);
  assert.match(html, /Preview options/);
  assert.match(html, /Model &amp; print info/);
